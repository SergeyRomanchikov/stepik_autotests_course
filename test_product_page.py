...
class TestUserAddToBasketFromProductPage():
    ...
    def setup(self, browser):
        ...
        self.login_page.register_new_user(username=email, password="QAws1234%")
...
def test_message_disappeared_after_adding_product_to_basket(browser):
    ...
    page = ProductPage(browser, link)
    page.open()
    page.is_success_message_after_adding_product_to_basket_disappeared()
...
def test_guest_cant_see_product_in_basket_opened_from_product_page(browser):
    ...
    basket_page.is_item_not_present()
    basket_page.is_basket_is_empty_message_displayed()
